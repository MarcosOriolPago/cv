...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \fill[left color=DockerBlue!85, right color=DockerPurple!70]
    (current page.north west) rectangle ([yshift=-5.2cm]current page.north east);
  % content container centered vertically within header height
  \node[anchor=north west, inner sep=0pt] at (current page.north west) {
    \begin{minipage}[c][5.2cm][c]{\paperwidth}
...
\tikz{\path[fill overzoom image={photo.png}] circle[radius=1.5cm];}
      ...
      \begin{minipage}[c]{0.72\paperwidth}
        ...
        {\small\color{white!92}{\faAt\ \href{mailto:marcos.oriol.p@gmail.com}{marcos.oriol.p@gmail.com}\quad
        ...
        \faGlobe\ \href{https://marcos.oriol-tech.com}{marcos.oriol-tech.com}}}\\[8pt]
        {\color{white!92}{\small Passionate software engineer focused on AI/ML and modern web technologies. I enjoy building clean architectures and great developer experiences.}}
      \end{minipage}
    \end{minipage}
  };
\end{tikzpicture}
