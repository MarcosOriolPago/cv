...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  % Description (wrapped)
  \node[anchor=west,align=left,text width=\dimexpr\linewidth-1.3cm\relax] at (0.45,-2.50) 
  ...
  % Icons
  \node[anchor=west] at (0.45,-4.10) {\skillicon{DockerWarning}{python-original}\hspace{3pt}\skillicon{DockerBlue}{docker-original}\hspace{3pt}\skillicon{DockerDanger}{tensorflow-original}\hspace{3pt}\skillicon{DockerPurple}{pytorch-original}};
