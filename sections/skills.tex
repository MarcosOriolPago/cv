...
\textbf{Spanish} \hfill Native\\
\begin{tikzpicture}
  \fill[DockerPurple!30] (0,0) rectangle (5, 0.2);
  \fill[DockerPurple] (0,0) rectangle (5, 0.2);
\end{tikzpicture}\\[2pt]
\textbf{English} \hfill Proficient (C1)\\
\begin{tikzpicture}
  \fill[DockerPurple!30] (0,0) rectangle (5, 0.2);
  \fill[DockerPurple] (0,0) rectangle (4.4, 0.2);
\end{tikzpicture}\\[2pt]
\textbf{Portuguese} \hfill Basic\\
\begin{tikzpicture}
  \fill[DockerPurple!30] (0,0) rectangle (5, 0.2);
  \fill[DockerPurple] (0,0) rectangle (1.2, 0.2);
\end{tikzpicture}
